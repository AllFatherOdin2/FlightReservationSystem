...
public class FlightSort{
	...
	private HashMap<String, IFlight> flight;
	
	public FlightSort(HashMap<String, IFlight> flightMap){
        this.flight = flightMap;
	}
	
	public ArrayList<IFlight> sortByPrice(){
		ArrayList<IFlight> flightList = Converter.convertMapToArray(flight);
	...
	public ArrayList<IFlight> sortByFlightTime(){
